...
csv_path = os.path.join(BASE_DIR, "..", "..", "DataSets", "Machine_Experiments", "Cleaned_MergedData.csv")

print(f"Reading data file from: {csv_path}")
...
print("Calculating statistical indicators (Rolling STD & RMS)...")
window_size = 10
...
print(df_cutting['Wear_Stage'].value_counts().sort_index())
...
print(f"\nLSTM data dimensions after shuffling: {X_time_series.shape}")
...
print("\nSaving all artifacts and the model...")
...
print("\nProcess completed successfully! Files are ready for the consumer.")