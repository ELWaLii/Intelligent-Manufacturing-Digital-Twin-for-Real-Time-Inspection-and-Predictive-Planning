...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, processed_path):
        ...
        print(" [Model Trainer] Optimizing Hyperparameters for Best Real Accuracy...")
        self.model.fit(
        ...
        print(" [Model Trainer] Optimized model saved successfully!")
